...
Return ONLY valid JSON, no markdown code blocks, no other text.
    ...
    async def invoke(self, query: str, session_id: str) -> str:
        ...
        try:
            ...
            print("[START] Successfully created structured analysis")
...
port = int(os.getenv("ANALYSIS_PORT", 9102))
...
def main():
    ...
    print(f"[INFO] Starting Analysis Agent (ADK + A2A) on http://localhost:{port}")
