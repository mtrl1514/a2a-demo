...
- **Research Agent**: http://localhost:9101
- **Analysis Agent**: http://localhost:9102
...
│   ├── orchestrator.py                # Orchestrator (ADK + AG-UI) - Port 9100
│   ├── research_agent.py              # Research (LangGraph + A2A) - Port 9101
│   ├── analysis_agent.py              # Analysis (ADK + A2A) - Port 9102
...
- Verify all services are running: `http://localhost:9100-9102`
